...
import numpy as np
from Inverse_Autoregressive_Flow_no_reg.AutoregressiveNN.AutoregressiveNN import AutoRegressiveNN_Unit
from Inverse_Autoregressive_Flow_no_reg.resnet import resnet_block
