...
class PixelCNN_Block(nn.Module):
    def __init__(self, n_hidden_layers=1):
        ...
        self.layer1 = MaskedConv2d("B", in_channels=1, out_channels=1, kernel_size=3, stride=1,
                                                           padding=1)
        self.means = MaskedConv2d("B", in_channels=1, out_channels=1, kernel_size=3, stride=1,
                                                           padding=1)
        self.sigma = MaskedConv2d("A", in_channels=1, out_channels=1, kernel_size=3, stride=1,
                                                           padding=1)
