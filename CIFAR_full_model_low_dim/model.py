...
import numpy as np
from CIFAR_full_model_low_dim.latent_block import LatentBlock
from CIFAR_full_model_low_dim.updward_block import UpwardBlock
from CIFAR_full_model_low_dim.x_z_dim_change_blocks import x_to_z_dim_Block, z_to_x_dim_Block

class VAE_ladder_model(nn.Module):
    """
    We have written Mnist version a bit more generally
    """
    def __init__(self, n_rungs=4, n_downsample_to_z=2, lambda_free_bits=0.25):
