from Mnist_fancy.Model import VAE_ladder_model
...
class VAE:
    def __init__(self, latent_dim=32, n_IAF_steps=2, h_dim=200, IAF_node_width=320, encoder_fc_dim=450, decoder_fc_dim=450
        ...
        self.VAE_model = VAE_ladder_model(latent_dim, n_IAF_steps, h_dim, IAF_node_width, encoder_fc_dim, decoder_fc_dim)\
            .to(self.device)
    ...
    def train(self, EPOCHS, train_loader, test_loader=None, save_model=False):
        train_history = {"loss": [],
                         "log_p_x_given_z": [],
                         "log_q_z_given_x": [],
                         "log_p_z ": []}
